...
namespace MAVIDI_ENERGY.Domain.Entities
{
    public class EnergyUsage
    {
        ...
        public decimal MonthlyConsumption { get; set; } // Alterado para decimal
        ...
        public decimal EstimatedCost { get; set; } // Alterado para decimal
        ...
        public decimal CO2Emissions { get; set; } // Alterado para decimal
